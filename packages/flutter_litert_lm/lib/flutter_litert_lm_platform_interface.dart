...
abstract class FlutterLitertLmPlatform extends PlatformInterface {
  ...
  /// Returns whether the model file supports native speculative decoding.
  Future<bool> hasSpeculativeDecodingSupport(String modelPath);

  /// Returns native benchmark counters for a conversation.
  Future<Map<String, dynamic>> getBenchmarkInfo(String conversationId);
}
